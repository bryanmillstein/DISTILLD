...
u2 = User.create!(email: "bobby@gmail.com", user_name: "bobby", password: "password")
...
p2 = u1.posts.create!(whisky_id: d2.id, body: "Best whisky_id ever.")
p3 = u2.posts.create!(whisky_id: d3.id, body: "Delicious.")
p4 = u2.posts.create!(whisky_id: d4.id, body: "Best")
p5 = u3.posts.create!(whisky_id: d5.id, body: "Delicious.")
p6 = u4.posts.create!(whisky_id: d6.id, body: "Need more...")
p7 = u1.posts.create!(whisky_id: d7.id, body: "Great after a long day.")
p8 = u1.posts.create!(whisky_id: d8.id, body: "Best whisky_id ever.")
...
p13 = u1.posts.create!(whisky_id: d13.id, body: "Great after a long day.")
p14 = u1.posts.create!(whisky_id: d14.id, body: "Best whisky_id ever.")
...
p19 = u1.posts.create!(whisky_id: d19.id, body: "Great after a long day.")
p20 = u1.posts.create!(whisky_id: d120.id, body: "Best whisky_id ever.")
