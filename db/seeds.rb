...
p1 = u5.posts.create!(whisky_id: d1.id, body: "Great after a long day.", place_id: 'cat')
p2 = u6.posts.create!(whisky_id: d2.id, body: "Best whisky_id ever.", place_id: 'cat')
p3 = u2.posts.create!(whisky_id: d3.id, body: "Delicious.", place_id: 'cat')
p4 = u2.posts.create!(whisky_id: d4.id, body: "Best", place_id: 'cat')
p5 = u3.posts.create!(whisky_id: d5.id, body: "Delicious.", place_id: 'dog')
p6 = u4.posts.create!(whisky_id: d6.id, body: "Need more...", place_id: 'dog')
p7 = u1.posts.create!(whisky_id: d7.id, body: "Great after a long day.", place_id: 'dog')
p8 = u1.posts.create!(whisky_id: d8.id, body: "Best whisky_id ever.", place_id: 'dog')
p9 = u2.posts.create!(whisky_id: d9.id, body: "Delicious.", place_id: 'dog')
